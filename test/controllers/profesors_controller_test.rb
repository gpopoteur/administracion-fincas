...
class ProfesorsControllerTest < ActionController::TestCase
  ...
  test "should create profesor" do
    assert_difference('Profesor.count') do
      post :create, profesor: { apellidos: @profesor.apellidos, direccion: @profesor.direccion, nombre: @profesor.nombre, sueldo: @profesor.sueldo, telefono: @profesor.telefono }
    end
  ...
  test "should update profesor" do
    patch :update, id: @profesor, profesor: { apellidos: @profesor.apellidos, direccion: @profesor.direccion, nombre: @profesor.nombre, sueldo: @profesor.sueldo, telefono: @profesor.telefono }
    assert_redirected_to profesor_path(assigns(:profesor))
  end
